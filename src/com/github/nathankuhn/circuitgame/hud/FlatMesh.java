...
public class FlatMesh {
    ...
    public static Mesh BuildHudMesh(Vector2f origin, Vector2f size, int rows, int cols) {
        return BuildHudMesh(origin.x, origin.y, size.x, size.y, rows, cols, 0.0f);
    }
    public static Mesh BuildHudMesh(Vector2f origin, Vector2f size, int rows, int cols, float zOffset) {
        return BuildHudMesh(origin.x, origin.y, size.x, size.y, rows, cols, zOffset);
    }
